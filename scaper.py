...
elems = soup.select("html body div.min-vh-100.container-fluid.bg-white.pb-3 div#myList.list-group a.list-group-item.list-group-item-action")
...
for chunks in elems :
     ...
     for i, coyChunks in enumerate(coyElems) :
          ...
          coyList = coyChunks.split("<strong>")
          ...
          coyName = coyList.split("</h")[0]
          # coyTel = coyList[9][9:]
          # coyEmail = coyList[17][9:]
